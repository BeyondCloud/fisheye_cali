...
int main(int argc, char* argv[])
{
    ...
    //! [file_read]
    Settings s;
    const string inputSettingsFile = argc > 1 ? argv[1] : "set.xml";
    ...
    s.inputCapture.set(CV_CAP_PROP_FOURCC ,CV_FOURCC('M', 'J', 'P', 'G') );
    s.inputCapture.set(CV_CAP_PROP_FRAME_WIDTH,640);
    s.inputCapture.set(CV_CAP_PROP_FRAME_HEIGHT,480);
    //! [file_read]
